<head>
	...
	<script>
		...
		function change2() {
  			...
  			document.getElementById("h2text").innerText = "Kai-Ming Huang";
		}
	</script>
</head>
...
<body>
	<table width="70%">
		<tr>
			...
			<td>
				<h1>黃楷茗</h1>
				<h2 id="h2text">Kai-Ming Huang</h2>
			</td>
		</tr>
	</table>
    ...
    <table width="70%">	
        ...
        width="350"
        height="430"
        src="https://console.dialogflow.com/api-client/demo/embedded/28ab7120-c868-405b-a16c-6cb9cd3f36a7">
        </iframe>
    </table>
	<?php echo date("Y-m-d")?>
</body>
